...
<!--          <a @click="handleEdit(record)">编辑</a>-->
              <a v-if="record.measureStatus === '2'" @click="handlemeasure(record,false)">设备验收</a>
              <a v-if="record.measureStatus === '3'" @click="handlemeasure(record,true)">计量记录</a>
...
<!--          </a-dropdown>-->
    ...
    <WmMeasureCheck-modal ref="modalForm" @ok="modalFormOk"></WmMeasureCheck-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmMeasureCheckModal from './modules/WmMeasureCheckModal'
  import {filterMultiDictText} from '@/components/dict/JDictSelectUtil'

  export default {
    name: "wmMeasureAcceptance",
    ...
    data () {
      return {
        ...
        url: {
          list: "/medical/wmMeasureHistory/checkList",
    ...
    methods: {
       ...
       * 设备计量
       */
      handlemeasure (record, isDetail) {
        this.$refs.modalForm.checkHandler(record,isDetail);
        this.$refs.modalForm.title = "设备计量-验收";
