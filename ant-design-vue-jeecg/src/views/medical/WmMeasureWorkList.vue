...
<!--          <a @click="handleEdit(record)">编辑</a>-->
              <a v-if="record.measureStatus === '0' || record.measureStatus === '1'" @click="handlemeasure(record)">设备计量</a>
    ...
    <WmMeasureWork-modal ref="modalForm" @ok="modalFormOk"></WmMeasureWork-modal>
  </a-card>
</template>
...
import WmMeasureWorkModal from './modules/WmMeasureWorkModal'
...
export default {
  ...
  data () {
    return {
      ...
      url: {
        list: "/medical/wmMeasureHistory/workList",
