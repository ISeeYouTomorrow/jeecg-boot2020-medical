    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="所属厂商" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['wmManufacturerId', validatorRules.wmManufacturerId]" :trigger-change="true" dictCode="wm_manufacturer_info,manufacturer_name,id" placeholder="请选择所属厂商"/>
        </a-form-item>
