        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-item label="维修单位" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag disabled type="list" v-decorator="['maintenanceProducer', validatorRules.maintenanceProducer]"
          ...
          <a-col :span="12">
            <a-form-item label="维修人" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input disabled v-decorator="[ 'maintenancePerson', validatorRules.maintenancePerson]" placeholder="请输入维修人"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="预计时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date disabled placeholder="请选择维修时间" v-decorator="[ 'maintenanceDate', validatorRules.maintenanceDate]"
                      :trigger-change="true" style="width: 100%"/>
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="维修费用" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input-number disabled v-decorator="[ 'maintenanceFee', validatorRules.maintenanceFee]" placeholder="请输入维修费用" style="width: 100%"/>
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="维修备注" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-textarea v-decorator="[ 'maintenanceRemark', validatorRules.maintenanceRemark]" placeholder="请输入维修备注"></a-textarea>
            </a-form-item>
          </a-col>
          <a-col :span="12">
...
<script>
  ...
  export default {
    name: "WmMaintenanceTreatmentModal",
    components: {
      JImageUpload,
      JUpload,
      JDictSelectTag,
      ...
      return {
        ...
        validatorRules: {
          ...
          maintenanceResult: {rules: [
              {required: true, message: '请选择维修结果!'},
            ]},
        },
        url: {
          add: "/medical/wmMaintenanceInfo/add",
          edit: "/medical/wmMaintenanceInfo/treatmentEdit",
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'problemPictures','maintenanceProducer','maintenancePerson','maintenanceDate','maintenanceFee','maintenanceRemark','maintenanceResult'))
        })
      },
      close () {
        this.$emit('close');
