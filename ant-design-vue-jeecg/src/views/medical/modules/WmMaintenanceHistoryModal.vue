    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="设备保养计划" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" @change="planChange" v-decorator="['maintenancePlanId', validatorRules.maintenancePlanId]" :trigger-change="true" dictCode="wm_maintenance_plan,paln_name,id" placeholder="请选择设备保养计划"/>
        </a-form-item>
        <a-form-item label="保养计划时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-model="plan.planTime" disabled></a-input>
        </a-form-item>
        <a-form-item label="预计保养费用" :labelCol="labelCol" :wrapperCol="wrapperCol">
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'maintenancePlanId','manufacturerId','manufacturerPerson'))
        })
      },
      /**
       * 获取所有计划设备
