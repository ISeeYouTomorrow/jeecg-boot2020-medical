        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-item label="保养费用" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input disabled v-model="model.maintenanceFee" style="width: 100%;"/>
            </a-form-item>
          </a-col>

          <a-col :span="12">
            <a-form-item label="保养结果" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag disabled type="list" v-model="model.maintenanceResult"
...
<script>
  ...
  export default {
    name: "WmMaintenanceAcceptanceModal",
    components: {
      JDate,
      JDictSelectTag,
    },
      ...
      return {
        ...
        */
        ...
        url: {
          ...
          edit: "/medical/wmMaintenanceHistory/checkHistory",
