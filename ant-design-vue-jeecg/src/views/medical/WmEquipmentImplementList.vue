...
<!--          <a @click="handleEdit(record)">编辑</a>-->
              <a v-if="record.maintenanceStatus === '0' || record.maintenanceStatus === '1'" @click="handleMaintenance(record)">设备保养</a>
...
<!--          </a-dropdown>-->
    ...
    <WmEquipmentImplement-modal ref="modalForm" @ok="modalFormOk"></WmEquipmentImplement-modal>
  </a-card>
</template>
...
<script>
  ...
  import WmEquipmentImplementModal from './modules/WmEquipmentImplementModal'
  import {filterMultiDictText} from '@/components/dict/JDictSelectUtil'

  export default {
    name: "WmEquipmentImplementList",
    mixins:[JeecgListMixin],
    components: {
      WmEquipmentImplementModal
    },
    data () {
      return {
        ...
        url: {
          list: "/medical/wmMaintenanceHistory/workList",
    ...
    methods: {
       ...
       * 设备保养
       */
      handleMaintenance (record) {
        this.$refs.modalForm.workHandler(record);
